...
class TestLogin:
    ...
    def test_login_valid_user_success(self, client, new_user):
        ...
        response = client.post(AuthEndpoints.LOGIN, {"email": user_data["email"], "password": user_data["password"]})
    ...
    def test_login_invalid_credentials_failure(self, client):
        response = client.post(AuthEndpoints.LOGIN, {"email": "badbad@test.ru", "password": "123456"})
